...
-- Windows style selection method
vim.keymap.set("n", "<C-S-Left>",  "vb", { desc = "Select previous word" })
vim.keymap.set("n", "<C-S-Right>", "vw", { desc = "Select next word" })
vim.keymap.set("v", "<C-S-Left>",  "b", { desc = "Extend selection left by word" })
vim.keymap.set("v", "<C-S-Right>", "w", { desc = "Extend selection right by word" })
...
-- Better jumping one word at the time
vim.keymap.set("n", "<C-Left>", "b", { desc = "Jump word left" })
vim.keymap.set("n", "<C-Right>", "w", { desc = "Jump word right" })

-- Resizing window
vim.keymap.set("n", "<S-Left>",  "<C-w><", { desc = "Shrink window horizontally" })
vim.keymap.set("n", "<S-Right>", "<C-w>>", { desc = "Grow window horizontally" })
vim.keymap.set("n", "<S-Up>",   "<C-w>+", { desc = "Grow window vertically" })
vim.keymap.set("n", "<S-Down>", "<C-w>-", { desc = "Shrink window vertically" })
...
function _G.SimpleTabline()
  ...
  for i = 1, vim.fn.tabpagenr("$") do
    ...
    -- get buffer of active window in tab
